...
class DataValidationConfig:
    ...
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.invalid_data_dir:str =os.path.join(self.data_validation_dir,training_pipeline.DATA_VALIDATION_INVALID_DIR_)
        ...
        self.drift_report_file_path:str = os.path.join(
            ...
            training_pipeline.DATA_VALIDATION_DRIFT_REPORT_DIR_,
